...
A recuperação de senha administrativa está desativada enquanto o GraziTur compartilhar o projeto Supabase Auth com outro sistema. O bloqueio existe na interface e no servidor; não reative o fluxo antes de isolar a autenticação.
